...
if $mini2; then
    ...
    prefix2=step2_mini
    rm -f $prefix2.tpr
    gmx_d grompp -f $prefix2.mdp -o $prefix2.tpr -c output/$prefix1.gro -r pdb2gmx/ionized.pdb -n pdb2gmx/index.ndx -p pdb2gmx/topol.top
    gmx_d mdrun -pin on -ntmpi 1 -ntomp 12 -v -s $prefix2.tpr -deffnm output/$prefix2
fi
