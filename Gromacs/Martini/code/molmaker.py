...
If you're using a forcefield with implicit screening (such as Martini) you'll want to set -eps to something else than the default.
...
%%prog [options]\n
Version 1.3.0-26-04-2013 by Manuel Melo (m.n.melo@rug.nl)""" % (mdp_template%("%intg%","%nsteps%","%eps%"))
    ...
    builder.add_argument("-x", dest="xmdp", help="Extra directives to include in the minimization .mdp.")
