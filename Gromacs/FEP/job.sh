...
gmx mdrun -ntomp 1 -deffnm min$LAMBDA
...
gmx grompp -f $MDP/EM/em_l-bfgs_$LAMBDA.mdp -c ../EM_1/min$LAMBDA.gro -p $FREE_ENERGY/$PDB/topol.top -o min$LAMBDA.tpr -maxwarn 1
...
gmx grompp -f $MDP/NVT/nvt_$LAMBDA.mdp -c ../EM_2/min$LAMBDA.gro -p $FREE_ENERGY/$PDB/topol.top -o nvt$LAMBDA.tpr

gmx mdrun -ntomp 1 -deffnm nvt$LAMBDA
...
gmx mdrun -ntomp 1 -deffnm npt$LAMBDA
...
gmx mdrun -ntomp 1 -deffnm md$LAMBDA
