...
infile  = sys.argv[1]
outfile = []
outfile.append(open('amber/step6.0_minimization.rest', 'w'))
outfile.append(open('amber/step6.1_equilibration.rest', 'w'))
outfile.append(open('amber/step6.2_equilibration.rest', 'w'))
outfile.append(open('amber/step6.3_equilibration.rest', 'w'))
outfile.append(open('amber/step6.4_equilibration.rest', 'w'))
outfile.append(open('amber/step6.5_equilibration.rest', 'w'))

fc_dihe  = [250.0, 250.0,  100.0,  50.0,  50.0,  25.0]
