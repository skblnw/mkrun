...
if $install_namd; then
  tar xvf "NAMD_${namd_version}_Linux-x86_64-multicore-CUDA-SingleNode.tar"
  mkdir "${install_base}/namd"
  mv "NAMD_${namd_version}_Linux-x86_64-multicore-CUDA-SingleNode" "${install_base}/namd/${namd_version}"
fi 
